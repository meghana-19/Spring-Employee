...
import com.employee.employeemgmt.controllerrepository.EmployeeRepo;
...
public class EmployeeController {
    ...
    @GetMapping("/getEmployeeById/{emp}")
    public Optional<Employee> getEmployeeById(@PathVariable Employee emp){
